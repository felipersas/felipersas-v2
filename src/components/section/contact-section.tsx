    ...
    <div className="border rounded-xl p-10 relative">
      ...
      <div className="relative flex flex-col items-center gap-4 text-center">
        ...
        <p className="mx-auto max-w-lg text-muted-foreground text-balance">
          ...
          <Link href={DATA.contact.social.email.url} className={linkClass}>
            {t('contact.email')}
          </Link>
          {t('contact.betweenLinks')}
          <Link href={DATA.contact.social.LinkedIn.url} target="_blank" rel="noopener noreferrer" className={linkClass}>
            {t('contact.linkedin')}
          </Link>
          {t('contact.afterLinkedin')}
        </p>
      </div>
    </div>
  );
