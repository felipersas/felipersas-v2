          ...
          {!isExpanded ? (
            ...
            >
              <button
                ...
                className="w-full flex items-center gap-3 hover:bg-accent/50 rounded-lg p-2 transition-colors"
              >
                <motion.div
                  ...
                  className="relative"
                >
                  <Disc3 className={cn("h-8 w-8 text-primary", isPlaying && "text-primary")} />
                  {isPlaying && (
                    <motion.div
                ...
                <div className="flex-1 min-w-0 text-left">
                  ...
                  <p className="text-xs text-muted-foreground truncate">
                    {currentTrack?.artist || 'Lo-Fi Player'}
                  </p>
                </div>
